...
Documentation is also described in the repository [docs/Interpreter Design.docx](https://github.com/avilanorwin/small-language-interpreter-js-implementation/blob/master/docs/Interpreter%20Design.docx)
